          ...
          <v-row justify="center" align="center">
            <v-col cols="12" sm="8" md="6" lg="4">
              <div>
                ...
                <img v-if="userProfilePicture" :src="userProfilePicture" alt="User Picture">
              </div>
            </v-col>
          </v-row>
        </v-container>
      ...
      export default {
        ...
        methods: {
          ...
          handleSubmit() {
            ...
            if (this.email === 'u@ex.com' && this.password === 'pass') {
              // Mock user data
              const user = {
                id: 1,
                name: 'John Doe',
      ...
      /* Adding some padding to the card */
      .v-card-text {
        padding: 24px;
      }
      
      /* Making the alert message more noticeable */
      .v-alert {
        margin-top: 16px;
      }
